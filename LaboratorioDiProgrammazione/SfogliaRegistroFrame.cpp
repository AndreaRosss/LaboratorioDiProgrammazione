...
SfogliaRegistroFrame::SfogliaRegistroFrame(wxFrame* parent,  Registro* registro) : wxFrame(parent, wxID_ANY, "Aggiungi Attivit‡"), registr(registro){
...
{
	registr->MostraAttivit‡SfogliaRegistroFrame(this);
}
